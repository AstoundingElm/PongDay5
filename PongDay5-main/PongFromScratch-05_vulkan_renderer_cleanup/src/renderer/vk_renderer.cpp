...
#include "/home/petermiller/Desktop/PongDay5-main/PongFromScratch-05_vulkan_renderer_cleanup/stb-master/stb_image.h"
...
#include "/home/petermiller/Desktop/PongDay5-main/PongFromScratch-05_vulkan_renderer_cleanup/src/dds_strcuts.h"
...
bool vk_init(VkContext *vkcontext,  xOrgWindInfo * windInfo)
{
...
surfaceInfo.connection = windInfo->connection;
surfaceInfo.window = windInfo->window;
VK_CHECK(vkCreateXcbSurfaceKHR(vkcontext->instance, &surfaceInfo, NULL, &vkcontext->surface));
    ...
    // Frame Buffers
    {
        ...
        fbInfo.width = windInfo->WINDOW_WIDTH;//vkcontext->screenSize.width;
        fbInfo.height = windInfo->WINDOW_WIDTH;//vkcontext->screenSize.height;
        fbInfo.layers = 1;
    ...
    // Create a Pipeline
    {
        ...
        // Vertex Shader
        {
            ...
            #else
            auto vertexCode = readFile("/home/petermiller/Desktop/PongDay5-main/PongFromScratch-05_vulkan_renderer_cleanup/assets/shaders/shader.vert.spv");
            //uint32_t * vertexCode = 0;
            #endif
            VkShaderModuleCreateInfo shaderInfo = {};
            shaderInfo.sType = VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO;
            shaderInfo.pCode = reinterpret_cast<const uint32_t*>(vertexCode.data());;
...
auto fragmentCode = readFile("/home/petermiller/Desktop/PongDay5-main/PongFromScratch-05_vulkan_renderer_cleanup/assets/shaders/shader.frag.spv");
            VkShaderModuleCreateInfo shaderInfo = {};
            shaderInfo.sType = VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO;
            shaderInfo.pCode = reinterpret_cast<const uint32_t*>(fragmentCode.data());
            shaderInfo.codeSize = fragmentCode.size();
    ...
    // Create Image
    {
        ...
        //DDSFile *data = readFile("C:/Users/peter/OneDrive/Desktop/PongFromScratch-05_vulkan_renderer_cleanup/assets/textures/cakez.DDS");//(DDSFile *)platform_read_file("C:/Users/peter/OneDrive/Desktop/PongFromScratch-05_vulkan_renderer_cleanup/assets/textures/cakez.DDS", &fileSize);
